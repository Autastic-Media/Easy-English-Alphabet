...
Public Class FormQ2_Done

    ' Declare PrintDocument with WithEvents to support print handling
    Private WithEvents PrintDocument1 As New PrintDocument()

    Private Sub FormQ2_Done_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtUserName.Text = ""
    ...
    Private Sub Button_Close_Click(sender As Object, e As EventArgs) Handles Button_Close.Click
        Me.Close()
        Form_Quiz2_3.Show() ' Restore final quiz form after results sanctuary closes
    End Sub
    ...
    Private Sub Button_Result_Click(sender As Object, e As EventArgs) Handles Button_Result.Click
        ...
        If dlg.ShowDialog() = DialogResult.OK Then
            ...
            ' Do NOT restore Form_Quiz2_3 again here
        End If
    End Sub
